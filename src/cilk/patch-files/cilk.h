...
/* JJH See http://us.generation-nt.com/answer/building-cilk-recent-linux-distribution-help-201502942.html */
...
FILE_IDENTITY(cilk_h_ident,
	      "$HeadURL: https://bradley.csail.mit.edu/svn/repos/cilk/5.4.3/runtime/cilk.h $ $LastChangedBy: bradley $ $Rev: 2672 $ $Date$");
